(function(window, undefined) {
  ...
  function applyTvstoreSetting() {
    var tvstore = window.navigator.panaSystem.tvstore;
    var vieraLanguage = tvstore.get('languageForTranslation');
    this.ctx.requestLocales.apply(this.ctx, [vieraLanguage]);
  }

  function initLocale() {
    applyTvstoreSetting.call(this);
    var tvstore = window.navigator.panaSystem.tvstore;
    tvstore.addObserver('languageEnv', function() {
      applyTvstoreSetting.call(this);
    }.bind(this));
