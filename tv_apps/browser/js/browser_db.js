...
(function (exports) {
  ...
  var BrowserDB = {
     ...
     * @param {Function} callback Runs on success with an array of
     *                            search engines
     */
     ...
     */
    setIconData:
    function browserDB_setIconData(iconUri, data, callback, failed) {
  ...
  BrowserDB.db = {
     ...
     */
    getPlacesByFrecency:
    function db_placesByFrecency(maximum, filter, callback) {
      var topSites = [];
      var self = this;
     ...
     */
    updatePlaceIconUri:
    function db_updatePlaceIconUri(uri, iconUri, callback) {
      var transaction = this._db.transaction(['places'], 'readwrite');
